...
(function (b) {
    b.MetroMessageBox = function (v, a) {
        ...
        if (isIE8orlower() == 0) {
            ...
            i.setAttribute("src","../assets/notifications/sound/messagebox.mp3");
            b.get();
...
(function (b) {
    b.bigBox = function (a, h) {
        ...
        if (isIE8orlower() == 0) {
            var i = document.createElement("audio");
                       i.setAttribute("src", "../assets/notifications/sound/bigbox.mp3");
            b.get();
            i.addEventListener("load", function () {
                i.play()
            }, true);
...
(function (b) {
    b.smallBox = function (o, j) {
        ...
        if (isIE8orlower() == 0) {
            ...
            k.setAttribute("src", "../assets/notifications/sound/smallbox.mp3");
            b.get();
