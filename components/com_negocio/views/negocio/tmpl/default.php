...
<div class="nav-tabs-custom">
	<ul class="nav nav-tabs">
		<li  ><a data-toggle="tab" href="#freelance">Usuario</a></li>
		<li class="active" ><a data-toggle="tab" href="#bussines">Negocio</a></li>

	</ul>

	<div class="tab-content">
		<div id="freelance" class="tab-pane ">
			<div>
				<section class="content-header">
					...
					<ol class="breadcrumb">
						<div class="btn-group">
							<button class="btn btn-action" id="addbutton_rrhh" data-toggle='tooltip' title='usuario_add' >
								<i class="fa fa-edit"></i> Nuevo
							</button>
							<button class="btn bg-red  btn-action" id="deletebutton_rrhh" data-toggle='tooltip' title='usuario_delete' >
